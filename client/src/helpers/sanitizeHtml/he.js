...
// https://html.specOrName.whatwg.org/multipage/syntax.html#table-charref-overrides.
...
const codePointToSymbol = function (codePoint, original, errors) {
  let output = "";
...
const parseError = function (message, errors) {
